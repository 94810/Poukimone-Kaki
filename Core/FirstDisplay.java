...
//Je suis un commentaire
    ...
    FirstDisplay(){
        ...
        ImageIcon poki = new ImageIcon(this.getClass().getResource(
                "poki.gif"));
       // poki.setBounds(150,280,110,35);


        //listPlayer1.setSelectedIndex(1);


        add(rb1);add(rb2);add(b);add(label);add(label1);add(label2);add(text1);add(text2);add(listPlayer1);
        add(listPlayer2);add(poki);
    ...
    public void actionPerformed(ActionEvent e){
     ...
     /*   if(rb1.isSelected()){
            JOptionPane.showMessageDialog(this,"you chosed mode PVP",x);
        }
        if(rb2.isSelected()){
